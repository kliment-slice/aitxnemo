    ...
    try:
        ...
        for chunk in stream:
            for choice in chunk.choices:
                ...
                # Handle reasoning content from Nemotron model
                reasoning_content = getattr(delta, "reasoning_content", None)
                if reasoning_content is not None:
                    # You can log or process reasoning content here if needed
                    pass
...
def patch_response_with_headers(
    ...
    """Apply the standard streaming headers expected by the AI SDK."""
